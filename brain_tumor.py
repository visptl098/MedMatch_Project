...
class BrainTumor:
    def __init__(self, use_pretrained = True) -> None:
        ...
        self.bt_optimizer = os.getenv('BT_OPTIMIZER', 'adam')
        self.bt_loss_function = os.getenv('BT_LOSS_FUNCTION', 'sparse_categorical_crossentropy')
    ...
    def build_cnn_model(self):
        ...
        model.compile(optimizer=self.bt_optimizer, loss=self.bt_loss_function, metrics=['accuracy'])
        self.model = model
